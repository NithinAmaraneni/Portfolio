      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 py-12 px-6 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <motion.div
              ...
              className="bg-white rounded-xl shadow-xl p-4 mb-8 flex justify-center space-x-4 backdrop-blur-sm bg-white/70"
          >
            <motion.button
          ...
          {activeTab === "view" && (
              <motion.div
                  ...
                  className="bg-white rounded-xl shadow-xl p-8 mb-8 backdrop-blur-sm bg-white/70"
              >
                <div className="mb-6">
          ...
          {activeTab === "download" && (
              <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: 0.3 }}
                  className="bg-white rounded-xl shadow-xl p-8 backdrop-blur-sm bg-white/70"
              >
                  ...
                  {Object.values(resumes).map((resume) => (
                      ...
                      >
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                          Perfect for printing or sharing digitally. Most widely accepted format.
                        </p>
                        <a
                            href={resume.pdf}
                            download
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                          Editable format. Use this if you need to make adjustments.
                        </p>
                        <a
                            href={resume.docx}
                            download
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              If you need a tailored version of my resume or have any questions about my experience, feel free to contact me.
            </p>
            <Link href="/contact">
              <motion.button
                  whileHover={{ scale: 1.05 }}
