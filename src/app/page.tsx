        ...
        <section className="relative flex flex-col md:flex-row items-center justify-center min-h-[90vh] px-6 overflow-hidden bg-gradient-to-br from-slate-50 to-gray-100">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full h-full">
                ...
                >
                    ...
                    >
                        Passionate about building scalable web applications and intelligent systems. I strive to merge the world of
                        software engineering with machine learning to solve real-world problems efficiently and innovatively.
                    </motion.p>
