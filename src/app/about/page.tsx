...
export default function About() {
  ...
  const projects = [
    { name: "Startup Ecosystem Tracker", color: "border-blue-500",tech:"Python, Streamlit, XGBoost, Linear Regression" },
    { name: "Advanced Contextual Question Answering Chatbot", color: "border-purple-500",tech:"Python, Pandas, Fuzzy Logic" },
    { name: " Stock Market Predication", color: "border-green-500",tech:"Python, Pandas, NumPy, Scikit learn" },
  ];
            ...
            <div className="flex flex-col items-center">
              <div className="relative w-40 h-40 mb-6 rounded-full overflow-hidden border-4 border-emerald-400 shadow-lg group">
                ...
                <Image 
                  ...
                  // Path to your profile image in public/assets
            ...
            <div className="space-y-4">
              {projects.map((project, index) => (
                <motion.div 
                  ...
                  className={`pl-4 py-3 border-l-4 ${project.color} bg-gray-50 rounded-r-lg shadow-sm transition-all duration-300 cursor-pointer`}
                >
                  <p className="text-gray-700">{project.name}</p>
                  <p className="text-gray-500 text-sm">{project.tech}</p>
                  <div className={`h-0.5 w-0 group-hover:w-full bg-gradient-to-r from-emerald-400 to-teal-500 transition-all duration-300`} />
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              {certifications.map((cert, index) => (
                ...
                >
                  <p className="text-gray-700 font-medium group-hover:text-emerald-600 transition-colors duration-300">{cert.name}</p>
